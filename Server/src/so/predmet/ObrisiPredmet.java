 ...
 * @author Luka
 */
public class ObrisiPredmet extends OpstaSO {

    public ObrisiPredmet(Object object, DBBroker db) {
        super(object, db);
    }
    ...
    protected void izvrsiOperaciju(Object object) throws Exception {
        ...
        for (Predaje p : predmet.getListaPredavanja()) {
            ...
            db.deleteWhereEqualsColumnSingle(p);
        }
        for (StudijskiProgram sp : predmet.getListaStudijskihPrograma()) {
            ...
            db.deleteWhereEqualsColumnSingle(psp);
        }
        db.deleteWhereEqualsColumnSingle(predmet);
    }
